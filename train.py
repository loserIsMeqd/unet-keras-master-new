...
tf.compat.v1.disable_eager_execution() #防止报错，详细见https://www.coder.work/article/5049740
...
if __name__ == "__main__":
    ...
    #   获取model
    #------------------------------------------------------#
    model_body = Unet([input_shape[0], input_shape[1], 3],
    ...
    if True:
        ...
        val_dataloader = UnetDataset(
            val_lines, input_shape, batch_size, num_classes, False, VOCdevkit_path)
        ...
        callbacks = [logging, loss_history, checkpoint,
                     checkpoint_last, checkpoint_best, lr_scheduler, eval_callback]
